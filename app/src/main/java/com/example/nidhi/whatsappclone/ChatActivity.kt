...
import com.example.nidhi.whatsappclone.adapters.ChatAdapter
import com.example.nidhi.whatsappclone.models.Inbox
import com.example.nidhi.whatsappclone.models.User
import com.example.nidhi.whatsappclone.utils.isSameDayAs
...
class ChatActivity : AppCompatActivity() {
    ...
    private fun updateLastMsg(msgMap: Messages) {
        val inboxMap = Inbox(msgMap.msg, friendId, friendName, friendImg)
