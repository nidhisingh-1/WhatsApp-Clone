package com.example.nidhi.whatsappclone.fragments
...
import com.example.nidhi.whatsappclone.*
import com.example.nidhi.whatsappclone.adapters.EmptyViewHolder
import com.example.nidhi.whatsappclone.adapters.UserViewHolder
        ...
        mAdapter = object : FirestorePagingAdapter<User, RecyclerView.ViewHolder>(options) {
            ...
            override fun onBindViewHolder(
                ...
                if (holder is UserViewHolder)
                    holder.bind(model) { name, uid, thumbImage ->
                        val intent = Intent(requireContext(), ChatActivity::class.java)
                        intent.putExtra(NAME, name)
                        intent.putExtra(UID, uid)
                        intent.putExtra(THUMBIMG, thumbImage)
